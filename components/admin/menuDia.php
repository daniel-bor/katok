    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="#"><i class="far fa-calendar-alt"></i>Menu del Dia</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" style="background-color: rgb(236, 236, 236);">
            ...
            <nav class="flex w-full h-12 text-2xl text-gray-100 bg-blue-800">
                <a href="./menuDia.php" class="mx-auto my-auto hover:text-gray-500">Salir</a>
                <a href="./add.php?add=03" class="mx-auto my-auto hover:text-gray-500">Agregar Imagen</a>
            </nav>
