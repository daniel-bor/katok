                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="./popup.php"><i class="far fa-comment-alt"></i>Pop-up Inicial</a>
                            </li>
                            <li>
                                <a href="#"><i class="fas fa-grip-horizontal"></i>Galeria Inicial</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fas fa-utensils"></i></i>Editar Menu's <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="menuPrincipal.php"><i class="fas fa-drumstick-bite"></i>Menu Principal</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" style="background-color: rgb(236, 236, 236);">
            <div style="font-size:2rem;">
                ...
                <nav class="flex w-full h-12 text-2xl text-gray-100 bg-blue-800">
                    <a href="./galeriaInicial.php" class="mx-auto my-auto hover:text-gray-500">Salir</a>
                    <a href="./add.php?add=01" class="mx-auto my-auto hover:text-gray-500">Agregar Imagen</a>
                </nav>
